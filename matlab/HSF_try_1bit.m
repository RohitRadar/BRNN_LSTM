...
for teta=cut:1:180
    for fi=0:1:180
        ...
        xlim([1 M])
        ylim([1 N])
        name = "D:/Data/Datasets/cyprus/codpic_1/"+num2str(teta)+'x'+num2str(fi)+".jpg";
        ...
        xlim([0 180])
        ylim([0 90])
        name = "D:/Data/Datasets/cyprus/radpic_1/"+num2str(teta)+'x'+num2str(fi)+".jpg";
        exportgraphics(gcf,name);
        drawnow
    
        writematrix(abs(F).^2,['D:/Data/Datasets/cyprus/radpat_1/' num2str(teta) 'x' num2str(fi) '.xlsx']);
        writematrix(PH,['D:/Data/Datasets/cyprus/codmat_1/' num2str(teta) 'x' num2str(fi) '.xlsx']);
    end
end